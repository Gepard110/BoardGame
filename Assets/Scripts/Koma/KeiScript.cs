...
public class KeiScript : MonoBehaviour {
    ...
    void Move() {
        if (Input.GetMouseButtonDown(0)) {
            ...
            Vector3 pos = this.transform.position;
            if (Mathf.Abs(pos.y - ClickedObject.transform.position.y) == 2 && Mathf.Abs(pos.x - ClickedObject.transform.position.x) == 1 && Vector2.Distance(pos, ClickedObject.transform.position) != 0) {
